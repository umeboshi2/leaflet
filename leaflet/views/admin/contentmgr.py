...
from leaflet.views.schema import NameSelectSchema, UploadFileSchema
from leaflet.views.schema import make_select_widget
...
class MainViewer(AdminViewer):
    ...
    def list_paths(self):
        template = 'leaflet:templates/admin-list-site-paths.mako'
    ...
    def list_resources(self):
        ...
        template = 'leaflet:templates/admin-list-site-resources.mako'
    ...
    def show_path_content(self):
        ...
        template = 'leaflet:templates/admin-show-site-path-content.mako'
        self.layout.content = self.render(template, env)
    ...
    def show_css(self):
        ...
        if 'update' in self.request.POST:
            ...
            template = 'leaflet:templates/admin-edit-sitecontent.mako'
