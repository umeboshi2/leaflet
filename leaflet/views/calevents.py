...
from leaflet.views.base import prepare_layout
from leaflet.views.base import BaseViewer


from leaflet.managers.events import EventManager

from leaflet.views.schema import AddUserSchema
...
class CalendarViewer(BaseViewer):
    ...
    def list_events(self):
        # setup widgetbox
        template = 'leaflet:templates/draggable-event-widget.mako'
        env = dict()
        self.layout.widgetbox = self.render(template, env)
        
        template = 'leaflet:templates/calendar-main.mako'
        env = dict()
    ...
    def view_event(self):
        ...
        template = 'leaflet:templates/view-calendar-event.mako'
    ...
    def manage_users(self):
        ...
        template = 'leaflet:templates/view-calendar-event-users.mako'
        rst = render_rst
